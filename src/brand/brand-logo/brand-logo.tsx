...
export class BrandLogo implements ComponentInterface {
   ...
   * Variant
   */
  @Prop() variant: typeof generatedBrands.logos[number];
  ...
  render(): JSX.Element {
    const iconSrc = `/assets/brand/logos/${this.variant}.svg`;
