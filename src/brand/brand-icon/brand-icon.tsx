...
@Component({
  tag: 'cds-brand-icon',
  styleUrls: ['brand-icon.scss'],
  assetsDirs: ['assets'],
})
export class BrandIcon implements ComponentInterface {
  /**
   * CSS Classes
   */
  @Prop() class = '';
   ...
   * Variant
   */
  @Prop() variant: typeof generatedBrands.icons[number];
  ...
  render(): JSX.Element {
    const iconSrc = `/assets/brand/icons/${this.variant}.svg`;
